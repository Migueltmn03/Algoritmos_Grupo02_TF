...
namespace GameIntro {
	...
	private:
		...
		void InitializeComponent(void)
		{
			...
			this->txtRules->Text = L"REGLAS DEL JUEGO:\n\n"
				L"1. Usa las teclas WASD o las flechas para moverte por el mapa.\n\n"
				L"2. Explora el mundo futurista donde la IA y el pensamiento humano colisionan.\n\n"
				L"3. Enfrenta enemigos predecibles y encuentra la manera de superarlos con creatividad.\n\n"
				L"4. Presiona ESC en cualquier momento para salir del juego.\n\n"
				L"¡Demuestra que la intuición humana puede vencer a la lógica fría!";
	...
	private:
		...
		void btnPlay_Click(System::Object^ sender, System::EventArgs^ e)
		{
			...
			// Abrir el juego después de la introducción
